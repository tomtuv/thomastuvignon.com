/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: bf3b5bbb7b76f5bbf3d1507f86118d24)
// Runtime types generated with workerd@1.20260520.1 2025-09-15 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTENTFUL_ACCESS_TOKEN" | "CONTENTFUL_PREVIEW_ACCESS_TOKEN" | "CONTENTFUL_PREVIEW_SECRET" | "CONTENTFUL_REVALIDATE_SECRET" | "CONTENTFUL_SPACE_ID" | "NEXT_PUBLIC_SITE_URL">> {}
}
