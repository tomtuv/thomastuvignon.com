		...
		<article>
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					...
					<a href="https://www.horsepilot.com/rain-free" target="_blank" rel="noopener" class="link">Voir la page</a>
				</div>
			</div>
		...
		<article>
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					...
					<a href="https://www.horsepilot.com/blog/fr/evenement" target="_blank" rel="noopener" class="link">Voir l’agenda</a>
				</div>
			</div>
		...
		<article>
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					...
					<a href="https://www.horsepilot.com/newsletter.html" target="_blank" rel="noopener" class="link">Voir le template</a>
				</div>
			</div>
