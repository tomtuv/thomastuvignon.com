...
<head>
	...
	<link rel="icon" href="http://thomastuvignon.com/sites/musee-de-la-mine/wp-content/uploads/2016/08/favicon.png">
...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		<div class="header-main">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img class="logo" src="http://thomastuvignon.com/sites/musee-de-la-mine/wp-content/uploads/2016/08/lanterne.png"><h1 class="site-title"><?php bloginfo( 'name' ); ?></a></h1>
